...
public class ResourceLoader {
    ...
    private final long mNativeDdsProvider;
    ...
    public ResourceLoader(@NonNull Engine engine) {
        ...
        mNativeDdsProvider = nCreateDdsProvider(nativeEngine);
        ...
        nAddTextureProvider(mNativeObject, "image/dds", mNativeDdsProvider);
        nAddTextureProvider(mNativeObject, "image/vnd-ms.dds", mNativeDdsProvider);
    }
    ...
    public void destroy() {
        ...
        nDestroyTextureProvider(mNativeDdsProvider);
    }
    ...
    private static native long nCreateDdsProvider(long nativeEngine);
